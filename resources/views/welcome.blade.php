    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent position-fixed w-100">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ Vite::asset('resources/images/Landing Page Images/logo.png') }}" alt=""
                    width="30" class="d-inline-block align-text-top me-1" />
                Nyilih Te-Lo
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div>
                    <a class="link-login" href="login"><button class="button-login">Masuk</button></a>
                </div>
        ...
        <div class="container h-100">
            <div class="row h-100 justify-content-center">
                <div class="col-md-8 justify-content-center text-center hero-tag my-auto">
                    ...
                    <a href="login"><button class="button-pr">Pinjam Sekarang</button></a>
                </div>
            </div>

            <img src="{{ Vite::asset('resources/images/Landing Page Images/it-telkom-surabaya.png') }}" alt=""
                class="position-absolute end-0 bottom-0 img-back" />
        </div>
    </section>
    <!-- Hero End -->
            ...
            <div class="row mt-5">
                <div class="col-md-4 justify-content-center text-center">
                    <div class="card-layanan card-1">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Layanan/layanan2.png') }}"
                            alt="" width="200px" />
                ...
                <div class="col-md-4 justify-content-center text-center">
                    <div class="card-layanan">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Layanan/layanan1.png') }}"
                            alt="" width="200px" />
                ...
                <div class="col-md-4 justify-content-center text-center">
                    <div class="card-layanan card-2">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Layanan/layanan3.png') }}"
                            alt="" width="200px" />
                        <p class="mt-3">
                ...
                <div class="col-10 mx-auto mt-5">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="barang-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="kelas-tab" data-bs-toggle="tab" data-bs-target="#kelas"
                                type="button" role="tab" aria-controls="kelas" aria-selected="false">
                                Ruang Kelas
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="lab-tab" data-bs-toggle="tab" data-bs-target="#lab"
                                type="button" role="tab" aria-controls="lab" aria-selected="false">
                                Ruang Lab
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="aula-tab" data-bs-toggle="tab" data-bs-target="#aula"
                                type="button" role="tab" aria-controls="aula" aria-selected="false">
                                Aula
                            </button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="barang" role="tabpanel"
                            ...
                            <div class="flex_items">
                                <img src="{{ Vite::asset('resources/images/Landing Page Images/jenis/Barang.png') }} "
                                    alt="" width="200px" />
                        ...
                        <div class="tab-pane fade" id="kelas" role="tabpanel" aria-labelledby="kelas-tab">
                            <div class="flex_items">
                                <img src="{{ Vite::asset('resources/images/Landing Page Images/jenis/kelas.png') }} "
                                    alt="" width="200px" />
                                <div class="selection-items">
                        ...
                        <div class="tab-pane fade" id="lab" role="tabpanel" aria-labelledby="lab-tab">
                            <div class="flex_items">
                                <img src="{{ Vite::asset('resources/images/Landing Page Images/jenis/lab.png') }} "
                                    alt="" width="200px" />
                                <div class="selection-items">
                        ...
                        <div class="tab-pane fade" id="aula" role="tabpanel" aria-labelledby="aula-tab">
                            <div class="flex_items">
                                <img src="{{ Vite::asset('resources/images/Landing Page Images/jenis/aula.png') }} "
                                    alt="" width="200px" />
                                <div class="selection-items">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi.png') }} "
                            alt="" />
                        <div class="card-body">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-1.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-2.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-3.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-4.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-5.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-6.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-md-3 mt-5">
                    <div class="card p-3">
                        <img src="{{ Vite::asset('resources/images/Landing Page Images/Ilustrasi Tata Cara/Illustrasi-7.png') }}"
                            alt="" />
                        <div class="card-body">
                            <div class="header-items">
                ...
                <div class="col-6">
                    <div class="row mt-5">
                        <div class="col-md-12 box-team">
                            <img src="{{ Vite::asset('resources/images/Landing Page Images/profile/Rectangle 10.png') }}"
                                alt="" width="200px" height="200px" style="border-radius: 10px 0 0 0" />
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 box-team">
                            <img src="{{ Vite::asset('resources/images/Landing Page Images/profile/Rectangle 11.png') }}"
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 box-team">
                            <img src="{{ Vite::asset('resources/images/Landing Page Images/profile/Rectangle 12.png') }}"
                                alt="" width="200px" height="200px" />
                            <div class="box-profile">
                                <p>Rizki Eka Putra</p>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 box-team">
                            <img src="{{ Vite::asset('resources/images/Landing Page Images/profile/Rectangle 17.png') }}"
                                alt="" width="200px" height="200px" style="border-radius: 0 0 0 10px" />
                            <div class="box-profile">
                                <p>Adyan Izza M.A</p>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <a class="navbar-brand" href="#">
                            <img src="{{ asset('Nyilih Te-Lo/assets/images/landing page/logo.png') }}" alt=""
                                width="30" class="d-inline-block align-text-top me-1" />
                            Nyilih Te-Lo
                        </a>
                    </div>
